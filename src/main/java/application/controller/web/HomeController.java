...
public class HomeController extends BaseController {
    ...
    public String home (Model model,
        ...
        listBanners.add(new BannerVM("", "Text 1","/images/slider/slider1.jpg"));
        listBanners.add(new BannerVM("", "Text 2","/images/slider/slider2.jpg"));
        listBanners.add(new BannerVM("", "Text 3","/images/slider/slider3.jpg"));
