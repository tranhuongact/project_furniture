...
public class OrderController extends BaseController {
    ...
    public String checkout(@Valid @ModelAttribute("order") OrderVM orderVM,
        ...
        if(flag == true) {
            ...
            //order.setPrice(Double.parseDouble(orderVM.getPrice()));
            ...
            if(cartEntity != null) {
                ...
                for (CartProduct cartProduct : cartEntity.getListCartProducts()) {
                    int productAmountInCart = cartProduct.getAmount();
                    Product product = productService.findOne(cartProduct.getProductId());
                    product.setAmount(product.getAmount() - productAmountInCart);
